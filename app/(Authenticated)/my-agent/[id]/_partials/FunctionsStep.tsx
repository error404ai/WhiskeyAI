                  ...
                  <div className="mt-4 grid grid-cols-[2fr,1fr] gap-4">
                    <div className="space-y-4">
                        ...
                        <TabsContent value="basic">
                          <div className="space-y-4">
                            <div className="space-y-2">
                              ...
                              <p className="text-muted-foreground text-xs">Use snake_case for function names (e.g. send_message)</p>
                            </div>
                            <div className="space-y-2">
                              <Label>
                                Description<span className="text-red-500">*</span>
                              </Label>
                              <Textarea placeholder="Ex: Call this function when a user asks you to tell them a joke about a specific topic" value={newFunction.description} onChange={(e) => setNewFunction({ ...newFunction, description: e.target.value })} />
                              <p className="text-muted-foreground text-xs">This is what your agent uses to interpret when it should call the function. Aim for 1-2 sentences describing when it should call the function and be descriptive.</p>
                            </div>
                            <div className="space-y-2">
                      ...
                      <div className="mt-4">
                        ...
                        <p className="text-muted-foreground mb-4 text-sm">Define the inputs required for this function</p>
