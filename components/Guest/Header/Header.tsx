...
const Header = () => {
  return (
    ...
    <div className="fixed z-50 container flex items-center justify-between bg-white px-5 py-4 shadow-md lg:px-20">
      <div className="flex items-center gap-12">
        <Logo />
        <div className="flex gap-10">
          <Link href="/agent" className="text-lg font-medium text-gray-800 transition-colors hover:text-blue-500">
            Agent
          </Link>
          <Link href="/faq" className="text-lg font-medium text-gray-800 transition-colors hover:text-blue-500">
            FAQ
          </Link>
        </div>
      </div>
